function [FS,FO] = algorithm_Ghoussayni(Hmarkers,Fmarkers,acase,gaitAxis,verticalAxis,n,f)
...
elseif strcmp(acase,'case2')
% -------------------------------------------------------------------------
% Detect events using the velocity threshold
% CASE #2: The event is defined when all markers with a velocity under
...
elseif strcmp(acase,'case3')
% -------------------------------------------------------------------------
% Detect events using the velocity threshold
% CASE #3: The event is defined when the hindfoot barycenter velocity has a 
%          velocity under threshold for FS, the forefoot barycenter over 
%          threshold for FO
% -------------------------------------------------------------------------
acase = 'case3';
twindow = fix(30/150*f); % two consecutive events must be at least distant of 30 frame (at 150 Hz)
