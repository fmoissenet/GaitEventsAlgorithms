function normData = normalised101(data,events) %,freq,firstFrame)
...
% FS1 = events(1) * freq;
% FS2 = events(2) * freq;
% FS1 = events(1) * freq - firstFrame + 1;
% FS2 = events(2) * freq - firstFrame + 1;
FS1 = events(1);
FS2 = events(2);
...
% %incrément en sec de 1% (pour 100 valeurs) => calcul du sample non arrondi
% %FS1 = 1%  ;  FS2 = 100%
% inc = (FS2 - FS1) / 99;
% 
% % Interpolation linéraire
